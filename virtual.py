    ...
    if __name__=='__main__':
        ...
        while True:
            ...
            if "goodbye" in statement or "ok bye" in statement or "stop" in statement:
                speak('your personal assistant Eva is shutting down,Good bye')
                print('your personal assistant Eva is shutting down,Good bye')
                root.destroy()
                break
            ...
            if 'wikipedia' in statement:
                ...
                speak('I am Eva version 1 point O your persoanl assistant. I am programmed to minor tasks like'
                ...
                speak("I was built by serverus - a group consisting of harshvardhan, veekaas, vanshika, princy and tamanna ")
                print("I was built by serverous - a group consisting of Harshvardhan, Vikas, Vanshika, Princy and Tamanna ")
...
label=tk.Label(root,text='EVA - Eva Voice Assistant',bg='DarkGoldenrod1',fg='black')
